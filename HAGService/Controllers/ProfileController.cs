...
namespace HAGService.Controllers
{
    ...
    public class ProfileController : ApiController
    {
        ...
        {
            return new ProfileBusiness().GetHelpMissionByMemberId(memberId, new List<string>() { "W", "R" });
        }
        ...
        {
            return new ProfileBusiness().GetHelpMissionByMemberId(memberId, new List<string>() { "F", "D" });
        }
        ...
        {
            return new ProfileBusiness().GetGiveMissionByMemberId(memberId, new List<string>() { "W", "R" });
        }
        ...
        {
            return new ProfileBusiness().GetGiveMissionByMemberId(memberId, new List<string>() { "F", "D" });
        }
        ...
        {
            return new ProfileBusiness().GetMemberEffectInfo(memberId);
        }
    }
}
